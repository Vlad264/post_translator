...
public class PoSTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PoSTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSingleResourceAccess().getGroup_2(), "rule__SingleResource__Group_2__0");
			...
			builder.put(grammarAccess.getProgramConfElementAccess().getGroup(), "rule__ProgramConfElement__Group__0");
			...
			builder.put(grammarAccess.getConfigurationAccess().getConfGlobVarsAssignment_2(), "rule__Configuration__ConfGlobVarsAssignment_2");
			builder.put(grammarAccess.getConfigurationAccess().getResourcesAssignment_3(), "rule__Configuration__ResourcesAssignment_3");
			...
			builder.put(grammarAccess.getSingleResourceAccess().getProgramConfsAssignment_2_0(), "rule__SingleResource__ProgramConfsAssignment_2_0");
			...
			builder.put(grammarAccess.getProgramConfigurationAccess().getAgrsAssignment_5_1(), "rule__ProgramConfiguration__AgrsAssignment_5_1");
			...
			builder.put(grammarAccess.getProgramConfElementAccess().getProgramVarAssignment_0(), "rule__ProgramConfElement__ProgramVarAssignment_0");
			builder.put(grammarAccess.getProgramConfElementAccess().getAssigAssignment_1(), "rule__ProgramConfElement__AssigAssignment_1");
			builder.put(grammarAccess.getProgramConfElementAccess().getGlobVarAssignment_2(), "rule__ProgramConfElement__GlobVarAssignment_2");
