...
public class InternalPoSTLexer extends Lexer {
    ...
    public final void mRULE_TIME_PREF_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1361:24: ( ( 'T' | 'TIME' ) )
            // InternalPoST.g:1361:26: ( 'T' | 'TIME' )
            {
            // InternalPoST.g:1361:26: ( 'T' | 'TIME' )
            int alt1=2;
    ...
    public final void mRULE_INTERVAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1363:15: ( ( RULE_INTEGER 'd' )? ( RULE_INTEGER 'h' )? ( RULE_INTEGER 'm' )? ( RULE_INTEGER 's' )? ( RULE_INTEGER 'ms' )? )
            // InternalPoST.g:1363:17: ( RULE_INTEGER 'd' )? ( RULE_INTEGER 'h' )? ( RULE_INTEGER 'm' )? ( RULE_INTEGER 's' )? ( RULE_INTEGER 'ms' )?
            {
            // InternalPoST.g:1363:17: ( RULE_INTEGER 'd' )?
            int alt2=2;
            alt2 = dfa2.predict(input);
            switch (alt2) {
                case 1 :
                    // InternalPoST.g:1363:18: RULE_INTEGER 'd'
                    {
                    mRULE_INTEGER(); 
                    match('d'); 
            ...
            // InternalPoST.g:1363:37: ( RULE_INTEGER 'h' )?
            int alt3=2;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalPoST.g:1363:38: RULE_INTEGER 'h'
                    {
                    mRULE_INTEGER(); 
                    match('h'); 
            ...
            // InternalPoST.g:1363:57: ( RULE_INTEGER 'm' )?
            int alt4=2;
            alt4 = dfa4.predict(input);
            switch (alt4) {
                case 1 :
                    // InternalPoST.g:1363:58: RULE_INTEGER 'm'
                    {
                    mRULE_INTEGER(); 
                    match('m'); 
            ...
            // InternalPoST.g:1363:77: ( RULE_INTEGER 's' )?
            int alt5=2;
            alt5 = dfa5.predict(input);
            switch (alt5) {
                case 1 :
                    // InternalPoST.g:1363:78: RULE_INTEGER 's'
                    {
                    mRULE_INTEGER(); 
                    match('s'); 
            ...
            // InternalPoST.g:1363:97: ( RULE_INTEGER 'ms' )?
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalPoST.g:1363:98: RULE_INTEGER 'ms'
                    {
                    mRULE_INTEGER(); 
                    match("ms"); 
    ...
    public final void mRULE_SIGNED_INTEGER_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1365:31: ( ( 'SINT' | 'INT' | 'DINT' | 'LINT' ) )
            // InternalPoST.g:1365:33: ( 'SINT' | 'INT' | 'DINT' | 'LINT' )
            {
            // InternalPoST.g:1365:33: ( 'SINT' | 'INT' | 'DINT' | 'LINT' )
            int alt7=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_UNSIGNED_INTEGER_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1367:33: ( ( 'USINT' | 'UINT' | 'UDINT' | 'ULINT' ) )
            // InternalPoST.g:1367:35: ( 'USINT' | 'UINT' | 'UDINT' | 'ULINT' )
            {
            // InternalPoST.g:1367:35: ( 'USINT' | 'UINT' | 'UDINT' | 'ULINT' )
            int alt8=4;
    ...
    public final void mRULE_REAL_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1369:21: ( ( 'REAL' | 'LREAL' ) )
            // InternalPoST.g:1369:23: ( 'REAL' | 'LREAL' )
            {
            // InternalPoST.g:1369:23: ( 'REAL' | 'LREAL' )
            int alt9=2;
    ...
    public final void mRULE_BIT_STRING_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1371:27: ( ( 'BOOL' | 'BYTE' | 'WORD' | 'DWORD' | 'LWORD' ) )
            // InternalPoST.g:1371:29: ( 'BOOL' | 'BYTE' | 'WORD' | 'DWORD' | 'LWORD' )
            {
            // InternalPoST.g:1371:29: ( 'BOOL' | 'BYTE' | 'WORD' | 'DWORD' | 'LWORD' )
            int alt10=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1373:14: ( ( RULE_DIGIT )+ )
            // InternalPoST.g:1373:16: ( RULE_DIGIT )+
            {
            // InternalPoST.g:1373:16: ( RULE_DIGIT )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_BINARY_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1375:21: ( '2#' ( RULE_BIT )+ )
            // InternalPoST.g:1375:23: '2#' ( RULE_BIT )+
            {
            match("2#"); 

            // InternalPoST.g:1375:28: ( RULE_BIT )+
            int cnt12=0;
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_OCTAL_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1377:20: ( '8#' ( RULE_OCTAL_DIGIT )+ )
            // InternalPoST.g:1377:22: '8#' ( RULE_OCTAL_DIGIT )+
            {
            match("8#"); 

            // InternalPoST.g:1377:27: ( RULE_OCTAL_DIGIT )+
            int cnt13=0;
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_HEX_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1379:18: ( '16#' ( RULE_HEX_DIGIT )+ )
            // InternalPoST.g:1379:20: '16#' ( RULE_HEX_DIGIT )+
            {
            match("16#"); 

            // InternalPoST.g:1379:26: ( RULE_HEX_DIGIT )+
            int cnt14=0;
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_BOOLEAN_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1381:22: ( ( 'TRUE' | 'FALSE' ) )
            // InternalPoST.g:1381:24: ( 'TRUE' | 'FALSE' )
            {
            // InternalPoST.g:1381:24: ( 'TRUE' | 'FALSE' )
            int alt15=2;
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            // InternalPoST.g:1383:22: ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) )
            // InternalPoST.g:1383:24: ( 'A' .. 'Z' | 'a' .. 'z' | '_' )
            {
    ...
    public final void mRULE_BIT() throws RecognitionException {
        try {
            // InternalPoST.g:1385:19: ( ( '0' | '1' ) )
            // InternalPoST.g:1385:21: ( '0' | '1' )
            {
    ...
    public final void mRULE_OCTAL_DIGIT() throws RecognitionException {
        try {
            // InternalPoST.g:1387:27: ( '0' .. '7' )
            // InternalPoST.g:1387:29: '0' .. '7'
            {
            matchRange('0','7'); 
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalPoST.g:1389:21: ( '0' .. '9' )
            // InternalPoST.g:1389:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_HEX_DIGIT() throws RecognitionException {
        try {
            // InternalPoST.g:1391:25: ( ( RULE_DIGIT | 'A' .. 'F' ) )
            // InternalPoST.g:1391:27: ( RULE_DIGIT | 'A' .. 'F' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1393:9: ( RULE_LETTER ( RULE_LETTER | RULE_DIGIT )* )
            // InternalPoST.g:1393:11: RULE_LETTER ( RULE_LETTER | RULE_DIGIT )*
            {
            mRULE_LETTER(); 
            // InternalPoST.g:1393:23: ( RULE_LETTER | RULE_DIGIT )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1395:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPoST.g:1395:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPoST.g:1395:24: ( options {greedy=false; } : . )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1397:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPoST.g:1397:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPoST.g:1397:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1399:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPoST.g:1399:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPoST.g:1399:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt21=0;
            loop21:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1401:16: ( . )
            // InternalPoST.g:1401:18: .
            {
            matchAny(); 
    ...
    class DFA5 extends DFA {
        ...
        public String getDescription() {
            return "1363:77: ( RULE_INTEGER 's' )?";
        }
    }
    static final String DFA22_eotS =
        "\1\13\3\34\3\uffff\1\31\1\uffff\1\47\1\51\1\uffff\6\34\3\51\1\34\1\uffff\1\31\2\uffff\2\34\1\uffff\3\34\5\uffff\2\34\3\uffff\1\51\15\34\1\uffff\1\51\1\34\3\uffff\7\34\1\133\14\34\1\uffff\2\34\1\133\1\34\1\153\1\34\1\47\1\155\1\uffff\1\133\1\34\1\133\3\34\1\162\2\34\1\165\2\153\3\34\1\uffff\1\171\1\uffff\1\153\1\165\1\153\1\162\1\uffff\2\162\1\uffff\1\155\1\172\1\34\2\uffff\1\174\1\uffff";
