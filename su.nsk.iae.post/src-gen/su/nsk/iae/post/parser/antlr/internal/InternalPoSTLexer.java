...
public class InternalPoSTLexer extends Lexer {
    ...
    public final void mT__32() throws RecognitionException {
        try {
            int _type = T__32;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:15:7: ( 'AT' )
            // InternalPoST.g:15:9: 'AT'
            {
            match("AT"); 
    ...
    public final void mT__35() throws RecognitionException {
        try {
            int _type = T__35;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:18:7: ( 'STRING' )
            // InternalPoST.g:18:9: 'STRING'
            {
            match("STRING"); 
    ...
    public final void mT__36() throws RecognitionException {
        try {
            int _type = T__36;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:19:7: ( 'WSTRING' )
            // InternalPoST.g:19:9: 'WSTRING'
            {
            match("WSTRING"); 
    ...
    public final void mRULE_DIRECT_VARIABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:972:22: ( '%' RULE_DIRECT_TYPE_PREFIX RULE_DIRECT_SIZE_PREFIX RULE_INTEGER ( '.' RULE_INTEGER )* )
            // InternalPoST.g:972:24: '%' RULE_DIRECT_TYPE_PREFIX RULE_DIRECT_SIZE_PREFIX RULE_INTEGER ( '.' RULE_INTEGER )*
            {
            match('%'); 
            mRULE_DIRECT_TYPE_PREFIX(); 
            mRULE_DIRECT_SIZE_PREFIX(); 
            mRULE_INTEGER(); 
            // InternalPoST.g:972:89: ( '.' RULE_INTEGER )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalPoST.g:972:90: '.' RULE_INTEGER
            	    {
            	    match('.'); 
            	    mRULE_INTEGER(); 
    ...
    public final void mRULE_DIRECT_TYPE_PREFIX() throws RecognitionException {
        try {
            // InternalPoST.g:974:34: ( ( 'I' | 'Q' | 'M' ) )
            // InternalPoST.g:974:36: ( 'I' | 'Q' | 'M' )
            {
    ...
    public final void mRULE_DIRECT_SIZE_PREFIX() throws RecognitionException {
        try {
            // InternalPoST.g:976:34: ( ( 'X' | 'B' | 'W' | 'D' | 'L' ) )
            // InternalPoST.g:976:36: ( 'X' | 'B' | 'W' | 'D' | 'L' )
            {
    ...
    public final void mRULE_TIME_PREF_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:978:24: ( ( 'T' | 'TIME' ) )
            // InternalPoST.g:978:26: ( 'T' | 'TIME' )
            {
            // InternalPoST.g:978:26: ( 'T' | 'TIME' )
            int alt2=2;
    ...
    public final void mRULE_INTERVAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:980:15: ( ( RULE_INTEGER 'd' )? ( RULE_INTEGER 'h' )? ( RULE_INTEGER 'm' )? ( RULE_INTEGER 's' )? ( RULE_INTEGER 'ms' )? )
            // InternalPoST.g:980:17: ( RULE_INTEGER 'd' )? ( RULE_INTEGER 'h' )? ( RULE_INTEGER 'm' )? ( RULE_INTEGER 's' )? ( RULE_INTEGER 'ms' )?
            {
            // InternalPoST.g:980:17: ( RULE_INTEGER 'd' )?
            int alt3=2;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalPoST.g:980:18: RULE_INTEGER 'd'
                    {
                    mRULE_INTEGER(); 
                    match('d'); 
            ...
            // InternalPoST.g:980:37: ( RULE_INTEGER 'h' )?
            int alt4=2;
            alt4 = dfa4.predict(input);
            switch (alt4) {
                case 1 :
                    // InternalPoST.g:980:38: RULE_INTEGER 'h'
                    {
                    mRULE_INTEGER(); 
                    match('h'); 
            ...
            // InternalPoST.g:980:57: ( RULE_INTEGER 'm' )?
            int alt5=2;
            alt5 = dfa5.predict(input);
            switch (alt5) {
                case 1 :
                    // InternalPoST.g:980:58: RULE_INTEGER 'm'
                    {
                    mRULE_INTEGER(); 
                    match('m'); 
            ...
            // InternalPoST.g:980:77: ( RULE_INTEGER 's' )?
            int alt6=2;
            alt6 = dfa6.predict(input);
            switch (alt6) {
                case 1 :
                    // InternalPoST.g:980:78: RULE_INTEGER 's'
                    {
                    mRULE_INTEGER(); 
                    match('s'); 
            ...
            // InternalPoST.g:980:97: ( RULE_INTEGER 'ms' )?
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalPoST.g:980:98: RULE_INTEGER 'ms'
                    {
                    mRULE_INTEGER(); 
                    match("ms"); 
    ...
    public final void mRULE_SIGNED_INTEGER_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:982:31: ( ( 'SINT' | 'INT' | 'DINT' | 'LINT' ) )
            // InternalPoST.g:982:33: ( 'SINT' | 'INT' | 'DINT' | 'LINT' )
            {
            // InternalPoST.g:982:33: ( 'SINT' | 'INT' | 'DINT' | 'LINT' )
            int alt8=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_UNSIGNED_INTEGER_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:984:33: ( ( 'USINT' | 'UINT' | 'UDINT' | 'ULINT' ) )
            // InternalPoST.g:984:35: ( 'USINT' | 'UINT' | 'UDINT' | 'ULINT' )
            {
            // InternalPoST.g:984:35: ( 'USINT' | 'UINT' | 'UDINT' | 'ULINT' )
            int alt9=4;
    ...
    public final void mRULE_REAL_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:986:21: ( ( 'REAL' | 'LREAL' ) )
            // InternalPoST.g:986:23: ( 'REAL' | 'LREAL' )
            {
            // InternalPoST.g:986:23: ( 'REAL' | 'LREAL' )
            int alt10=2;
    ...
    public final void mRULE_BIT_STRING_TYPE_NAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:988:27: ( ( 'BOOL' | 'BYTE' | 'WORD' | 'DWORD' | 'LWORD' ) )
            // InternalPoST.g:988:29: ( 'BOOL' | 'BYTE' | 'WORD' | 'DWORD' | 'LWORD' )
            {
            // InternalPoST.g:988:29: ( 'BOOL' | 'BYTE' | 'WORD' | 'DWORD' | 'LWORD' )
            int alt11=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:990:14: ( ( RULE_DIGIT )+ )
            // InternalPoST.g:990:16: ( RULE_DIGIT )+
            {
            // InternalPoST.g:990:16: ( RULE_DIGIT )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_BINARY_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:992:21: ( '2#' ( RULE_BIT )+ )
            // InternalPoST.g:992:23: '2#' ( RULE_BIT )+
            {
            match("2#"); 

            // InternalPoST.g:992:28: ( RULE_BIT )+
            int cnt13=0;
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_OCTAL_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:994:20: ( '8#' ( RULE_OCTAL_DIGIT )+ )
            // InternalPoST.g:994:22: '8#' ( RULE_OCTAL_DIGIT )+
            {
            match("8#"); 

            // InternalPoST.g:994:27: ( RULE_OCTAL_DIGIT )+
            int cnt14=0;
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_HEX_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:996:18: ( '16#' ( RULE_HEX_DIGIT )+ )
            // InternalPoST.g:996:20: '16#' ( RULE_HEX_DIGIT )+
            {
            match("16#"); 

            // InternalPoST.g:996:26: ( RULE_HEX_DIGIT )+
            int cnt15=0;
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_BOOLEAN_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:998:22: ( ( 'TRUE' | 'FALSE' ) )
            // InternalPoST.g:998:24: ( 'TRUE' | 'FALSE' )
            {
            // InternalPoST.g:998:24: ( 'TRUE' | 'FALSE' )
            int alt16=2;
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            // InternalPoST.g:1000:22: ( ( 'A' .. 'Z' | 'a' .. 'z' | '_' ) )
            // InternalPoST.g:1000:24: ( 'A' .. 'Z' | 'a' .. 'z' | '_' )
            {
    ...
    public final void mRULE_BIT() throws RecognitionException {
        try {
            // InternalPoST.g:1002:19: ( ( '0' | '1' ) )
            // InternalPoST.g:1002:21: ( '0' | '1' )
            {
    ...
    public final void mRULE_OCTAL_DIGIT() throws RecognitionException {
        try {
            // InternalPoST.g:1004:27: ( '0' .. '7' )
            // InternalPoST.g:1004:29: '0' .. '7'
            {
            matchRange('0','7'); 
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalPoST.g:1006:21: ( '0' .. '9' )
            // InternalPoST.g:1006:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_HEX_DIGIT() throws RecognitionException {
        try {
            // InternalPoST.g:1008:25: ( ( RULE_DIGIT | 'A' .. 'F' ) )
            // InternalPoST.g:1008:27: ( RULE_DIGIT | 'A' .. 'F' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1010:9: ( RULE_LETTER ( RULE_LETTER | RULE_DIGIT )* )
            // InternalPoST.g:1010:11: RULE_LETTER ( RULE_LETTER | RULE_DIGIT )*
            {
            mRULE_LETTER(); 
            // InternalPoST.g:1010:23: ( RULE_LETTER | RULE_DIGIT )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1012:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalPoST.g:1012:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalPoST.g:1012:24: ( options {greedy=false; } : . )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1014:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalPoST.g:1014:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalPoST.g:1014:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1016:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalPoST.g:1016:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalPoST.g:1016:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt22=0;
            loop22:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalPoST.g:1018:16: ( . )
            // InternalPoST.g:1018:18: .
            {
            matchAny(); 
    ...
    class DFA6 extends DFA {
        ...
        public String getDescription() {
            return "980:77: ( RULE_INTEGER 's' )?";
        }
    }
    static final String DFA23_eotS =
        "\1\16\1\36\1\uffff\1\41\1\uffff\1\36\2\uffff\2\36\1\uffff\1\34\1\56\1\60\1\uffff\6\36\3\60\1\36\1\uffff\1\34\2\uffff\1\36\5\uffff\1\106\2\uffff\4\36\2\uffff\2\36\3\uffff\1\60\15\36\1\uffff\1\60\1\36\3\uffff\1\36\1\uffff\6\36\1\143\14\36\1\uffff\3\36\1\143\1\36\1\164\1\56\1\165\1\uffff\1\143\1\36\1\143\3\36\1\172\2\36\1\175\2\164\1\36\1\177\2\36\2\uffff\1\164\1\175\1\164\1\172\1\uffff\2\172\1\uffff\1\165\1\uffff\1\u0082\1\36\1\uffff\1\u0084\1\uffff";
    static final String DFA23_eofS =
        "\u0085\uffff";
    static final String DFA23_minS =
        "\1\0\1\145\1\uffff\1\75\1\uffff\1\124\2\uffff\1\111\1\117\1\uffff\1\111\1\60\1\43\1\uffff\1\116\2\111\1\104\1\105\1\117\1\43\2\60\1\101\1\uffff\1\52\2\uffff\1\154\5\uffff\1\60\2\uffff\1\122\1\116\1\124\1\122\2\uffff\1\115\1\125\3\uffff\1\60\1\124\1\116\1\117\1\116\1\105\1\117\1\111\1\116